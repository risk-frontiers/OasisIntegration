...
### Notes: 
* A more detailed documentation can be found in [oasis_complex_model_manual.pdf](https://github.com/risk-frontiers/OasisComplexModel/oasis_complex_model_manual.pdf).
